                                    ...
                                    <tr
                                        ...
                                        <td scope="row"
                                            ...
                                            <a href="{{ route('todo.edit', $data) }}"
                                                class="text--600 dark:text-blue-400 hover:underline text-sm">{{ $data->title }}</a>
                                        </td>
                                        ...
                                        <td class="px-6 py-4">
                                            @if ($data->is_done == false)
                                                <span
                                                    class="inline-flex items-center bg-red-100 text-red-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-lg dark:bg-red-900 dark:text-red-300">
                                                    On Going
                                                </span>
                                            @elseif ($data->is_done == true)
                                                <span
                                                    class="inline-flex items-center bg-green-100 text-green-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-lg dark:bg-green-900 dark:text-green-300">
                                                    Done
                                                </span>
                                            @endif
                                        </td>
                                            ...
                                            <div class="flex space-x-4">
                                                @if ($data->is_done == false)
                                                    <form action="{{ route('todo.complete', $data) }}" method="Post">
                                                        ...
                                                        @method('PATCH')
                                                        <button type="submit"
                                                            class="text-green-600 dark:text-green-400 text-sm px-4 py-2 rounded-lg bg-green-100 hover:bg-green-200 transition duration-200">
                                                            Complete
                                                        </button>
                                                    </form>
                                                @else
                                                    <form action="{{ route('todo.uncomplete', $data) }}" method="Post">
                                                        ...
                                                        @method('PATCH')
                                                        <button type="submit"
                                                            class="text-blue-600 dark:text-blue-400 text-sm px-4 py-2 rounded-lg bg-blue-100 hover:bg-blue-200 transition duration-200">
                                                            Uncomplete
                                                        </button>
                                                    </form>
                                                @endif
                                                ...
                                                <form action="{{ route('todo.destroy', $data) }}" method="POST">
                                                    ...
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="text-red-600 dark:text-red-400 text-sm px-4 py-2 rounded-lg bg-red-100 hover:bg-red-200 transition duration-200">
                                                        Delete
                                                    </button>
                                                </form>
                                            </div>
